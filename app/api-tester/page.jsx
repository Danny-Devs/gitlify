...
export default function ApiTester() {
  ...
  const loadTemplate = template => {
    ...
    const headers =
      typeof template.headers === 'string'
    ...
    const authConfig =
      typeof template.auth_config === 'string'
  ...
  const handleSaveTemplate = async () => {
    ...
    const savedTemplate = await saveRequestTemplate(
      templateName,
      requestConfig
    );
    if (savedTemplate) {
  ...
  const inputClass =
    'px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 dark:bg-gray-700 dark:text-white';
  const selectClass =
    'px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 dark:bg-gray-700 dark:text-white';
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className="lg:col-span-3 space-y-6">
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="md:col-span-1">
                          <select
                            ...
                            onChange={e =>
                              handleAuthChange('type', e.target.value)
                            }
                    ...
                    <div className="mb-4">
                      <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Log this request with API Key (optional)
                      </h3>
                      <select
                    ...
                    <div className="mb-4">
                      ...
                      {Object.keys(requestConfig.headers).length === 0 ? (
                        ...
                        <div className="space-y-2">
                          {Object.entries(requestConfig.headers).map(
                            ([key, value], index) => (
                              <div
                                key={index}
